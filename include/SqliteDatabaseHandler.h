        ...
        Row fetch()
        {
            ...
            for( int i = 0; i < columnCount; i++ )
            {
                ...
                if (columnText != nullptr) {
                    columnValue = std::string(reinterpret_cast<const char*>(columnText));
                } else {
                    columnValue = "NULL"; // valor  para representar NULL
                }
            ...
            while(sqlite3_step(stmt)==SQLITE_ROW)
            {
                ...
                for( int i = 0; i < columnCount; i++ )
                {
                    ...
                    if (columnText != nullptr) {
                        ...
                        columnValue = "NULL"; // o cualquier otro valor que quieras usar para representar NULL
                    }
                    row[columnName] = columnValue;
                } 
                table.push_back(row);
